...
const About = () => {
  ...
  return (
    <div
      id="about-us"
      className="bg-[#4B443F] w-screen 2xl:p-40 p-4 py-10 flex flex-col md:flex-row"
    >
      {/* Bagian Kiri (30%) */}
      <div
        className="w-full md:w-[40%] flex items-start md:items-start justify-start"
      ...
      {/* Bagian Kanan (70%) */}
      <div
        className="w-full md:w-[60%] flex justify-start items-start flex-col gap-10"
      ...
      >
        <h1 className="text-4xl md:text-[80px] font-bold font-glyphic leading-tight tracking-normal">
          Your <span className="text-main">strategic</span> partner that deliver{" "}
          <span className="text-main">innovation</span> and{" "}
          <span className="text-main">sustainability</span>
        </h1>
